import{_ as n,c as s,o as a,b as t}from"./app.b0c91c0f.js";const y='{"title":"axios\u4E00\u4E2A\u57FA\u4E8Epromise\u7684HTTP\u5E93","description":"","frontmatter":{},"headers":[{"level":3,"title":"axios\u4E00\u4E2A\u57FA\u4E8Epromise\u7684HTTP\u5E93","slug":"axios\u4E00\u4E2A\u57FA\u4E8Epromise\u7684http\u5E93"}],"relativePath":"tool/axios.md"}',p={},o=t(`<h3 id="axios\u4E00\u4E2A\u57FA\u4E8Epromise\u7684http\u5E93" tabindex="-1">axios\u4E00\u4E2A\u57FA\u4E8Epromise\u7684HTTP\u5E93</h3><h4 id="\u5B89\u88C5" tabindex="-1">\u5B89\u88C5</h4><div class="language-sh"><pre><code>yarn add axios
...
axios<span class="token function">#patch</span><span class="token punctuation">(</span>url<span class="token punctuation">[</span><span class="token punctuation">,</span> data<span class="token punctuation">[</span><span class="token punctuation">,</span> config<span class="token punctuation">]</span><span class="token punctuation">]</span><span class="token punctuation">)</span>
</code></pre></div><h4 id="\u8BF7\u6C42\u914D\u7F6E" tabindex="-1">\u8BF7\u6C42\u914D\u7F6E</h4><p>\u8FD9\u4E9B\u662F\u521B\u5EFA\u8BF7\u6C42\u65F6\u53EF\u4EE5\u7528\u7684\u914D\u7F6E\u9009\u9879\u3002\u53EA\u6709 url \u662F\u5FC5\u9700\u7684\u3002\u5982\u679C\u6CA1\u6709\u6307\u5B9A method\uFF0C\u8BF7\u6C42\u5C06\u9ED8\u8BA4\u4F7F\u7528 get \u65B9\u6CD5\u3002</p><div class="language-js"><pre><code><span class="token punctuation">{</span>
 ...
 <span class="token comment">// \`auth\` \u8868\u793A\u5E94\u8BE5\u4F7F\u7528 HTTP \u57FA\u7840\u9A8C\u8BC1\uFF0C\u5E76\u63D0\u4F9B\u51ED\u636E</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span>
</code></pre></div><h4 id="\u54CD\u5E94\u7ED3\u6784" tabindex="-1">\u54CD\u5E94\u7ED3\u6784</h4><p>\u67D0\u4E2A\u8BF7\u6C42\u7684\u54CD\u5E94\u5305\u542B\u4EE5\u4E0B\u4FE1\u606F</p><div class="language-js"><pre><code><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h4 id="\u4F7F\u7528-then-\u65F6\uFF0C\u4F60\u5C06\u63A5\u6536\u4E0B\u9762\u8FD9\u6837\u7684\u54CD\u5E94" tabindex="-1">\u4F7F\u7528 then \u65F6\uFF0C\u4F60\u5C06\u63A5\u6536\u4E0B\u9762\u8FD9\u6837\u7684\u54CD\u5E94 :</h4><div class="language-js"><pre><code>axios<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token string">&#39;/user/12345&#39;</span><span class="token punctuation">)</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre></div><h4 id="\u914D\u7F6E\u9ED8\u8BA4\u503C" tabindex="-1">\u914D\u7F6E\u9ED8\u8BA4\u503C</h4><div class="language-js"><pre><code>axios<span class="token punctuation">.</span>defaults<span class="token punctuation">.</span>baseURL <span class="token operator">=</span> <span class="token string">&#39;https://api.example.com&#39;</span><span class="token punctuation">;</span>
...
</code></pre></div><h4 id="\u81EA\u5B9A\u4E49\u5B9E\u4F8B\u9ED8\u8BA4\u503C" tabindex="-1">\u81EA\u5B9A\u4E49\u5B9E\u4F8B\u9ED8\u8BA4\u503C</h4><div class="language-js"><pre><code><span class="token comment">// Set config defaults when creating the instance</span>
<span class="token keyword">const</span> instance <span class="token operator">=</span> axios<span class="token punctuation">.</span><span class="token function">create</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
...
</code></pre></div><h4 id="\u914D\u7F6E\u7684\u4F18\u5148\u987A\u5E8F" tabindex="-1">\u914D\u7F6E\u7684\u4F18\u5148\u987A\u5E8F</h4><p>\u914D\u7F6E\u4F1A\u4EE5\u4E00\u4E2A\u4F18\u5148\u987A\u5E8F\u8FDB\u884C\u5408\u5E76\u3002\u8FD9\u4E2A\u987A\u5E8F\u662F\uFF1A\u5728 lib/defaults.js \u627E\u5230\u7684\u5E93\u7684\u9ED8\u8BA4\u503C\uFF0C\u7136\u540E\u662F\u5B9E\u4F8B\u7684 defaults \u5C5E\u6027\uFF0C\u6700\u540E\u662F\u8BF7\u6C42\u7684 config \u53C2\u6570\u3002\u540E\u8005\u5C06\u4F18\u5148\u4E8E\u524D\u8005\u3002\u8FD9\u91CC\u662F\u4E00\u4E2A\u4F8B\u5B50</p><div class="language-js"><pre><code><span class="token comment">// \u4F7F\u7528\u7531\u5E93\u63D0\u4F9B\u7684\u914D\u7F6E\u7684\u9ED8\u8BA4\u503C\u6765\u521B\u5EFA\u5B9E\u4F8B</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre></div><h4 id="\u62E6\u622A\u5668" tabindex="-1">\u62E6\u622A\u5668</h4><p>\u5728\u8BF7\u6C42\u6216\u54CD\u5E94\u88AB then \u6216 catch \u5904\u7406\u524D\u62E6\u622A\u5B83\u4EEC\u3002</p><div class="language-js"><pre><code><span class="token comment">// \u6DFB\u52A0\u8BF7\u6C42\u62E6\u622A\u5668</span>
...
instance<span class="token punctuation">.</span>interceptors<span class="token punctuation">.</span>request<span class="token punctuation">.</span><span class="token function">use</span><span class="token punctuation">(</span><span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token comment">/*...*/</span><span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre></div><h4 id="\u9519\u8BEF\u5904\u7406" tabindex="-1">\u9519\u8BEF\u5904\u7406</h4><div class="language-js"><pre><code>axios<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token string">&#39;/user/12345&#39;</span><span class="token punctuation">)</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre></div><h4 id="\u53D6\u6D88" tabindex="-1">\u53D6\u6D88</h4><p>\u4F7F\u7528 cancel token \u53D6\u6D88\u8BF7\u6C42 Axios \u7684 cancel token API \u57FA\u4E8Ecancelable promises proposal\uFF0C\u5B83\u8FD8\u5904\u4E8E\u7B2C\u4E00\u9636\u6BB5\u3002</p><h4 id="\u53EF\u4EE5\u4F7F\u7528-canceltoken-source-\u5DE5\u5382\u65B9\u6CD5\u521B\u5EFA-cancel-token\uFF0C\u50CF\u8FD9\u6837" tabindex="-1">\u53EF\u4EE5\u4F7F\u7528 CancelToken.source \u5DE5\u5382\u65B9\u6CD5\u521B\u5EFA cancel token\uFF0C\u50CF\u8FD9\u6837</h4><div class="language-js"><pre><code><span class="token keyword">const</span> CancelToken <span class="token operator">=</span> axios<span class="token punctuation">.</span>CancelToken<span class="token punctuation">;</span>
...
</code></pre></div><h4 id="\u8FD8\u53EF\u4EE5\u901A\u8FC7\u4F20\u9012\u4E00\u4E2A-executor-\u51FD\u6570\u5230-canceltoken-\u7684\u6784\u9020\u51FD\u6570\u6765\u521B\u5EFA-cancel-token\uFF1A" tabindex="-1">\u8FD8\u53EF\u4EE5\u901A\u8FC7\u4F20\u9012\u4E00\u4E2A executor \u51FD\u6570\u5230 CancelToken \u7684\u6784\u9020\u51FD\u6570\u6765\u521B\u5EFA cancel token\uFF1A</h4><div class="language-js"><pre><code><span class="token keyword">const</span> CancelToken <span class="token operator">=</span> axios<span class="token punctuation">.</span>CancelToken<span class="token punctuation">;</span>
...
</code></pre></div>`,35),e=[o];function c(u,l,k,r,i,m){return a(),s("div",null,e)}var f=n(p,[["render",c]]);export{y as __pageData,f as default};
